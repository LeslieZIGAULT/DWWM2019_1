...
<?php
echo "<div>
<p> L'appellation de pierre précieuse, officiellement abrogée par la législation française en janvier 20021 est une dénomination historique qui s'applique en France aux quatre gemmes que sont le diamant, le saphir, le rubis et l'émeraude.
...
<?php
echo "<h2>Bienvenue sur votre application</h2>";
?>
